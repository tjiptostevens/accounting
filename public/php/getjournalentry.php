...
if ($_SERVER['REQUEST_METHOD'] == 'OPTIONS') {
    ...
    IF
        ( tabjournalentry.acc <=> NULL, NULL, tabchartofaccount.`name` ) AS acc_name,
    IF
        ( tabjournalentry.acc <=> NULL, NULL, tabjournalentry.idx ) AS idx,
    IF
        ( tabjournalentry.acc <=> NULL, NULL, tabjournalentry.parent ) AS parent,
    IF
